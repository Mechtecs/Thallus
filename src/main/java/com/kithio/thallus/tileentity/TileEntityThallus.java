...
public class TileEntityThallus extends TileEntity
{
    ...
    public void writeToNBT(NBTTagCompound nbtTagCompound)
    {
        ...
        if (this.hasOwner())
        {
            ...
            nbtTagCompound.setLong(Names.NBT.OWNER_UUID_MOST_SIG, ownerUUID.getLeastSignificantBits());
        }
    }
    ...
    {
        return PacketHandler.INSTANCE.getPacketFrom(new MessageTileEntityThallus(this));
    }
}
